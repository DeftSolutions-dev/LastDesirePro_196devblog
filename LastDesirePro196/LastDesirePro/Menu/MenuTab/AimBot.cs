...
namespace LastDesirePro.Menu.MenuTab
{
    internal class AimBot
    {
        ...
        public static string[] tb = new string[] { "AimBot", "Silent Aim", "pSilent", "HitChange", "Friend List" };
                ...
                case 0:
                    {
                        ...
                        ScrollViewMenu(new Rect(15, 85, 375, 415), ref _AimBot, () =>
                        {
                            ...
                            if (_aim)
                            {
                                ...
                                Slider(0f, 380f, ref _aimfov, 200, $"{string.Format("{0}", (int)_aimfov)}.");
                                Toggle("Prediction", ref _aimPred);  
                                GUILayout.Space(5f);
                                using (new GUILayout.HorizontalScope())
                                {
                                    GUIContent[] target = { new GUIContent("Head"), new GUIContent("Neck"), new GUIContent("Chest"), new GUIContent("Body") };
                                    if (Button("◄", 25))
                                    {
                                        _aimBodyList--;
                                        if (_aimBodyList == -1)
                ...
                case 2:
                    {
                        ScrollViewMenu(new Rect(15, 85, 370, 415), ref _pSilent, () =>
                        {
                            ...
                            if (_pAim)
                            {
                                ...
                                Slider(0f, 380f, ref _pAimfov, 200, $"{string.Format("{0}", (int)_pAimfov)}.");
                                GUILayout.Space(5f);
                                using (new GUILayout.HorizontalScope())
                                {
                ...
                case 3:
                    {
                        ScrollViewMenu(new Rect(15, 85, 370, 415), ref _Hit, () =>
                        {
                            ...
                            if (_hitBoxPlayer)
                            {
                                ...
                                using (new GUILayout.HorizontalScope())
                                {
                                    GUIContent[] target = { new GUIContent("Head"),
                                        new GUIContent("Chest"), new GUIContent("Body") };
                                    if (Button("◄", 25))
                                    {
                                        _hitBoxPlayerList--;
                                ...
                                Slider(0f, 3f, ref _hitBoxPlayerRadius, 200, $"{string.Format("{0:0.#}", (float)_hitBoxPlayerRadius)} m.");
                            }
                            GUILayout.EndVertical(); 
                        });
