    ...
    public static void DoMisc() {
      ...
      case 0: {
        ScrollViewMenu(new Rect(15, 85, 370, 415), ref _Weapon, () => {
          ...
          if (_recoil)
            Slider(0 f, 100 f, ref _recoilFloat, 200, $ "{string.Format(" {
                0
              }
              ", (int)_recoilFloat)}.");
          Toggle("Spread", ref _spread, 16);
          if (_spread)
            Slider(0 f, 100 f, ref _spreadFloat, 200, $ "{string.Format(" {
                0
              }
              ", (int)_spreadFloat)}.");
          ...
          if (_thickness)
            Slider(0 f, 100 f, ref _thicknessFloat, 200, $ "{string.Format(" {
                0
              }
              ", (int)_thicknessFloat)}.");
          Toggle("Thickness Melee", ref _thicknessMelee, 16);
          if (_thicknessMelee)
            Slider(0 f, 100 f, ref _thicknessMeleeFloat, 200, $ "{string.Format(" {
                0
              }
              ", (int)_thicknessMeleeFloat)}.");
      ...
      case 1: {
        ScrollViewMenu(new Rect(15, 85, 370, 415), ref _Movement, () => {
          ...
          if (_speed) {
            Slider(0 f, 6 f, ref _move, 200, $ "{string.Format("
              Standing: {
                0: 0. #
              }
              ", (float)_move)}.");
            Slider(0 f, 6 f, ref _srint, 200, $ "{string.Format("
              Sprint: {
                0: 0. #
              }
              ", (float)_srint)}.");
            Slider(0 f, 6 f, ref _siting, 200, $ "{string.Format("
              Sitting: {
                0: 0. #
              }
              ", (float)_siting)}.");
          ...
          if (_time) {
            Slider(0 f, 20, ref _timeScale, 200, $ "{string.Format("
              Speed: {
                0: 0. #
              }
              Sec ", (float)_timeScale)}.");
        ...
        ScrollViewMenu(new Rect(395, 85, 370, 415), ref _Movement1, () => {
          ...
          if (CFG.AutomaticConfig._fieldOfView)
            Slider(0 f, 35 f, ref CFG.AutomaticConfig._fieldOfViewRadius, 200, $ "{string.Format("
              FOV: {
                0: 0. #
              }
              ", CFG.AutomaticConfig._fieldOfViewRadius)}.");
          GUILayout.EndVertical();
        });
        break;
      }
      case 2: {
        ScrollViewMenu(new Rect(15, 85, 370, 415), ref _Misc, () => {
          ...
          if (_hitLog)
            Slider(0 f, 10 f, ref _hitLogTime, 200, $ "{string.Format("
              Time Hit Log: {
                0: 0. #
              }
              ", _hitLogTime)}.");
        ...
        ScrollViewMenu(new Rect(395, 85, 370, 415), ref _Misc1, () => {
          ...
          if (_chat) {
            ...
            Slider(0.5 f, 6 f, ref _timeChat, 200, $ "{string.Format("
              Time: {
                0: 0. #
              }
              ",  _timeChat)}.");
          ...
          if (_timeDay)
            Slider(0 f, 24 f, ref _timeScrol, 200, $ "{string.Format("
              Time: {
                0: 0. #
              }
              Hour.
          ...
          if (_customSky) {
            Slider(0 f, 1000 f, ref _star, 200, $ "{string.Format("
              Star: {
                0
              }
              ", (int)_star)}.");
            Slider(1 f, 20 f, ref _atmosphere, 200, $ "{string.Format("
              Atmosphere: {
                0
              }
              ", (int)_atmosphere)}.");
