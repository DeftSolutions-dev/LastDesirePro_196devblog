    ...
    public static void DoVisual() {
      ...
      case 0: {
        ...
        ScrollViewMenu(new Rect(15, 85, 375, 415), ref _Players, () => {
          ...
          if (_players[7]) {
            Toggle("Ignore Local", ref _players[14], 16);
            GUILayout.Space(5 f);
            using(new GUILayout.HorizontalScope()) {
              GUIContent[] chams = {
                new GUIContent("Chams"),
                new GUIContent("Color Chams"),
                new GUIContent("Pulsing"),
                new GUIContent("Rainbow"),
                new GUIContent("Wireframe"),
          ...
          GUILayout.Space(50 f);
          Toggle("Text background", ref _players[8], 16, _colorFon, true, 7);
          GUILayout.EndVertical();
          Slider(0, 5 f, ref _radiusFon, 200, $ "Background rounding:  {string.Format(" {
              0: 0. #
            }
            ", (float)_radiusFon)}");
        });
        if (_players[0]) {
          ScrollViewMenu(new Rect(400, 85, 245, 415), ref _PlayersModels, () => {
            ...
            ), new Vector2(120 f, //Точка B - Лево, право по оси Х
              80 //Точка B - Верх, низ по оси Y
            ), Menu.CFG.VisuаlCоnfig._colorBone, 1, true);
            Main.Visuals.FullDrawing.Line(new Vector2(120 f, 80), new Vector2(140, 88), Menu.CFG.VisuаlCоnfig._colorBone, 1, true);
            ...
            Main.Visuals.FullDrawing.Line(new Vector2(120 f, 80), new Vector2(100, 94), Menu.CFG.VisuаlCоnfig._colorBone, 1, true);
            ...
            Main.Visuals.FullDrawing.Line(new Vector2(120 f, 80), new Vector2(119, 148), Menu.CFG.VisuаlCоnfig._colorBone, 1, true);
      ...
      case 1: {
        ScrollViewMenu(new Rect(15, 85, 750, 415), ref _Animals, () => {
          ...
          GUILayout.EndVertical();
          GUILayout.Space(5 f);
          Slider(0, 5 f, ref _radiusFonAnimal, 200, $ "Background rounding:  {string.Format(" {
              0: 0. #
            }
            ", (float)_radiusFonAnimal)}");
          GUILayout.Space(5 f);
      ...
      case 2: {
        ScrollViewMenu(new Rect(15, 85, 370, 415), ref _Resources, () => {
          ...
          GUILayout.EndVertical();
          GUILayout.Space(5);
          Slider(0, 5 f, ref _radiusFonResource, 200, $ "Background rounding:  {string.Format(" {
              0: 0. #
            }
            ", (float)_radiusFonResource)}");
          GUILayout.Space(5);
        ...
        ScrollViewMenu(new Rect(395, 85, 370, 415), ref _Resources1, () => {
          ...
          GUILayout.EndVertical();
          GUILayout.Space(5);
          Slider(0, 5 f, ref _radiusFonCollectible, 200, $ "Background rounding:  {string.Format(" {
              0: 0. #
            }
            ", (float)_radiusFonCollectible)}");
          GUILayout.Space(5);
      ...
      case 3: {
        ScrollViewMenu(new Rect(15, 85, 370, 415), ref _Home, () => {
          ...
          GUILayout.EndVertical();
          GUILayout.Space(5);
          Slider(0, 5 f, ref _radiusFonContainer, 200, $ "Background rounding:  {string.Format(" {
              0: 0. #
            }
            ", (float)_radiusFonContainer)}");
          GUILayout.Space(5);
        ...
        ScrollViewMenu(new Rect(395, 85, 370, 415), ref _Home1, () => {
          ...
          if (_cupboard[0]) {
            ...
            GUILayout.Space(5);
            Slider(0, 5 f, ref _radiusFonCupboard, 200, $ "Background rounding:  {string.Format(" {
                0: 0. #
              }
              ", (float)_radiusFonCupboard)}");
            GUILayout.Space(5);
          ...
          if (_autoturret[0]) {
            ...
            GUILayout.Space(5);
            Slider(0, 5 f, ref _radiusFonAutoTurret, 200, $ "Background rounding:  {string.Format(" {
                0: 0. #
              }
              ", (float)_radiusFonAutoTurret)}");
            GUILayout.Space(5);
          ...
          if (_stash[0]) {
            ...
            GUILayout.Space(5);
            Slider(0, 5 f, ref _radiusFonStash, 200, $ "Background rounding:  {string.Format(" {
                0: 0. #
              }
              ", (float)_radiusFonStash)}");
            GUILayout.Space(5);
          ...
          if (_trap[0] || _trap[1] || _trap[2] || _trap[3]) {
            ...
            GUILayout.Space(5);
            Slider(0, 5 f, ref _radiusFonTrap, 200, $ "Background rounding:  {string.Format(" {
                0: 0. #
              }
              ", (float)_radiusFonTrap)}");
            GUILayout.Space(5);
          ...
          if (_droppedItem[0]) {
            ...
            GUILayout.Space(5);
            Slider(0, 5 f, ref _radiusFonDroppedItem, 200, $ "Background rounding:  {string.Format(" {
                0: 0. #
              }
              ", (float)_radiusFonDroppedItem)}");
            GUILayout.Space(5);
      ...
      case 4: {
        ScrollViewMenu(new Rect(15, 85, 370, 415), ref _Home, () => {
          ...
          if (_Helicopter[0] || _Helicopter[2]) {
            ...
            Slider(0, 5 f, ref _radiusFonHelicopter, 200, $ "Background rounding:  {string.Format(" {
                0: 0. #
              }
              ", (float)_radiusFonHelicopter)}");
          }
          ...
          if (_BradleyAPC[0] || _BradleyAPC[2]) {
            ...
            Slider(0, 5 f, ref _radiusFonBradleyAPC, 200, $ "Background rounding:  {string.Format(" {
                0: 0. #
              }
              ", (float)_radiusFonBradleyAPC)}");
          }
          ...
          if (_raid[8]) {
            ...
            Slider(0, 600 f, ref _secondRaid, 200, $ "Second :  {string.Format(" {
                0
              }
              ", (int)_secondRaid)}");
            Toggle("Text background", ref _raid[7], 16, _colorFonRaid, true, 93);
            Slider(0, 5 f, ref _radiusFonRaid, 200, $ "Background rounding:  {string.Format(" {
                0: 0. #
              }
              ", (float)_radiusFonRaid)}");
          }
        ...
        ScrollViewMenu(new Rect(395, 85, 370, 415), ref _Home1, () => {
          ...
          GUILayout.EndVertical();
          Slider(0, 5 f, ref _radiusFonStorage, 200, $ "Background rounding:  {string.Format(" {
              0: 0. #
            }
            ", (float)_radiusFonStorage)}");
